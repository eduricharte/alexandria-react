    ...
    <div className="flex flex-col w-screen h-screen">
      ...
      <div className="space-y-6 flex flex-row h-auto px-20 py-12 text-white bg-blue-600">
        ...
        <div className="content-center -w-2/5">
          <img src={Reading} width="391" height="" />
        </div>
      </div>
        ...
        <div className="flex flex-col w-full h-full items-center">
            <div className="divide-y-2 divide-black">
                <div className=" flex text-center pb-3 h-1/2 px-30 pt-16 text-4xl font-black" style={{ fontFamily: "Muli, sans-serif" }}>
                    <span>Features</span>
                </div>
                <div className="flex content-center h-1/2 px-30 pt-16" />
            </div>
        </div>

        {/**Blazingly Fast */}
        <div className="flex flex-row">
            <div className="flex flex-row bg-pink-200 px-6 py-6">
                <div className="content-center self-center">
                    <img src={Fast} width="" height="333" />
                </div>
            <div className="text-pink-600 -w-1/2">
                <div className='divide-y-2 divide-pink-600 space-y-6'>
                    <div style={{ fontFamily: "Muli, sans-serif" }} className="font-extrabold text-4xl">
                        Blazingly Fast
                    </div>
                    <div style={{ fontFamily: "Lato, sans-serif" }} className='pt-6'>
            ...
            {/**Trends */}
        <div className="flex flex-row">
            <div style={{backgroundColor: "#283593"}} className="flex flex-row px-6 py-6">
                <div className="content-center self-center">
                    <img src={Trends} width="" height="333" />
                </div>
            <div className="text-pink-300 -w-1/2">
                <div className='divide-y-2 divide-pink-300 space-y-6'>
                    <div style={{ fontFamily: "Muli, sans-serif" }} className="font-extrabold text-4xl">
                        Trends
                    </div>
                    <div style={{ fontFamily: "Lato, sans-serif" }} className='pt-6'>
        ...
        {/**Accesibility */}
        <div style={{backgroundColor: "#006064"}} className="space-y-6 flex flex-row pl-20 py-12 text-white bg-teal-600">
            <div className="content-center">
                <img src={Files} width="340" height="" />
            </div>
            <div className="pl-32 divide-y-2 content-center self-center">
                <div style={{ fontFamily: "Muli, sans-serif" }} className="font-extrabold text-4xl pb-2">
                    Accessibility
                </div>
            <div style={{ fontFamily: "Lato, sans-serif" }} className="w-2/3 pt-6">
      ...
      <div className="flex flex-col w-full h-full items-center">
        <div className="divide-y-2">
          <div
            className=" flex justify-center content-center pb-3 h-1/2 px-30 pt-16 text-4xl font-black"
            style={{ fontFamily: "Muli, sans-serif" }}
          >
